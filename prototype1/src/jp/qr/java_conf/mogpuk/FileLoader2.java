...
public class FileLoader2 extends AsyncTask<String, Integer, String> {
    ...
    public FileLoader2(Activity act) {
    	
   	     mActivity = act;

    }

    public FileLoader2(Activity act,List<NameValuePair> nameValuePair) {
        mode = "post";
