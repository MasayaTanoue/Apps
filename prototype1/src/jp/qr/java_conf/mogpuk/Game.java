...
public class Game extends Activity implements OnClickListener  {
 ...
 sta = new int[9];
	...
	public void onResume(){
		super.onResume();
		//音楽の読み込み
  		bgm_game = MediaPlayer.create(getBaseContext(), R.raw.bgm_game);
							 ...
							 @Override
					            public void onClick(View v) {
								 if (bgm_game.isPlaying()) {
									...
									//経営終了時刻の計算
									long end_time=time+60*1000;
									
									//設定がされているなら放置時間をを半分に
								    SharedPreferences po2 = getSharedPreferences("tgl", MODE_PRIVATE);
							        int sta = po2.getInt("status"+8, 0);
							        if(sta==1){
							        	end_time=time+30*1000;
							        }
									...
									Intent it = new Intent(Game.this, Go.class);
